...
enum _SearchBody {
  ...
  ///
  /// The suggested queries are generated by [SearchDelegateWidget.buildSuggestions].
  suggestions,

  /// Search results are currently shown in the body.
  ///
  /// The search results are generated by [SearchDelegateWidget.buildResults].
  results,
}
...
class _SearchPageRoute<T> extends PageRoute<T> {
  _SearchPageRoute({
    ...
    assert(
      ...
      'search. Please close that search by calling close() on the SearchDelegateWidget '
      'before opening another search with the same delegate instance.',
    );
    delegate._route = this;
  }

  final SearchDelegateWidget<T> delegate;
